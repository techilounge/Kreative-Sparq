...
const result = Object.fromEntries(
  chapters.map((chapter) => [keys[chapter.number], parseChapter(chapter)]),
);
...
if (process.argv.includes("--check")) {
  ...
  if (current !== serialized) {
    throw new Error(
      "Conversion content is out of date. Run node scripts/extract-conversion.mjs.",
    );
  }
  process.stdout.write("Conversion content matches the approved copy deck.\n");
} else {
